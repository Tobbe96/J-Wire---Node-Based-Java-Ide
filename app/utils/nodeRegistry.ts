...
export const NODE_CATEGORIES = {
  ...
  Logic: ['main', 'method', 'constructor', 'callMethod', 'callStaticMethod', 'callInstanceMethod', 'newObject', 'branch', 'while', 'for', 'doWhile', 'switch', 'tryCatchFinally', 'throw', 'break', 'continue', 'setVar', 'setLocalVar', 'print', 'return', 'increment', 'compoundAssign'],
