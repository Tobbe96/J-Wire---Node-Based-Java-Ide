  ...
  files: [
    // ─── File 1: TodoApp.java ──────────────────────────────────
    {
      ...
      nodes: [
        ...
        { id: 'append-display', type: 'swingControlOp', position: { x: 6500, y: 200 },
          data: { label: 'Append to Display', operation: 'append', controlType: 'JTextArea', variableName: 'taskDisplay' } },
        { id: 'fmt-task-nl', type: 'stringFormat', position: { x: 6350, y: 350 },
          data: { label: 'String.format', formatString: '%s\\n', argCount: 1 } },
        { id: 'dialog-add', type: 'swingDialogOp', position: { x: 6800, y: 200 },
          data: { label: 'Message Dialog', operation: 'showMessageDialog' } },
        { id: 'lit-add-dlg-title', type: 'literal', position: { x: 6650, y: 350 },
          data: { label: 'Literal', literalType: 'String', value: 'Added' } },
        { id: 'lit-add-dlg-msg', type: 'literal', position: { x: 6650, y: 420 },
          data: { label: 'Literal', literalType: 'String', value: 'Task has been added!' } },

        // Event: Remove button → call clearTasks then show dialog
        { id: 'evt-remove', type: 'swingEventOp', position: { x: 7100, y: 0 },
          data: { label: 'Remove Listener', operation: 'addActionListener', variableName: 'removeBtn' } },
        { id: 'call-clear', type: 'callInstanceMethod', position: { x: 7300, y: 200 },
          data: { label: 'Call clearTasks', methodName: 'TaskManager.clearTasks' } },
        { id: 'get-mgr-clear', type: 'getter', position: { x: 7150, y: 300 },
          data: { label: 'manager', type: 'TaskManager' } },
        { id: 'clear-display', type: 'swingControlOp', position: { x: 7600, y: 200 },
          data: { label: 'Clear Display', operation: 'setText', controlType: 'JTextArea', variableName: 'taskDisplay' } },
        { id: 'lit-empty', type: 'literal', position: { x: 7450, y: 350 },
          data: { label: 'Literal', literalType: 'String', value: '' } },
        { id: 'dialog-remove', type: 'swingDialogOp', position: { x: 7900, y: 200 },
          data: { label: 'Message Dialog', operation: 'showMessageDialog' } },
        { id: 'lit-remove-title', type: 'literal', position: { x: 7750, y: 350 },
          data: { label: 'Literal', literalType: 'String', value: 'Cleared' } },
        { id: 'lit-remove-msg', type: 'literal', position: { x: 7750, y: 420 },
          data: { label: 'Literal', literalType: 'String', value: 'All tasks cleared!' } },

        // Add main panel to frame + center + show
        { id: 'frame-add', type: 'swingPanelOp', position: { x: 8200, y: 0 },
          data: { label: 'Add to Frame', operation: 'add', variableName: 'this' } },
        { id: 'frame-center', type: 'swingFrameOp', position: { x: 8500, y: 0 },
          data: { label: 'JFrame: Center', operation: 'setLocationRelativeTo', variableName: 'this' } },
        { id: 'frame-visible', type: 'swingFrameOp', position: { x: 8800, y: 0 },
          data: { label: 'JFrame: Set Visible', operation: 'setVisible', variableName: 'this' } },
        { id: 'lit-true', type: 'literal', position: { x: 8700, y: 150 },
          data: { label: 'Literal', literalType: 'boolean', value: 'true' } },
      ],
      edges: [
        // ═══ Exec chain ═══
        ...
        { id: 'e-call-add-append', source: 'call-add', target: 'append-display', sourceHandle: 'exec-out', targetHandle: 'exec-in' },
        { id: 'e-append-dlg', source: 'append-display', target: 'dialog-add', sourceHandle: 'exec-out', targetHandle: 'exec-in' },
        { id: 'e-evt-remove-body', source: 'evt-remove', target: 'call-clear', sourceHandle: 'event-body', targetHandle: 'exec-in' },
        { id: 'e-call-clear-clrdisplay', source: 'call-clear', target: 'clear-display', sourceHandle: 'exec-out', targetHandle: 'exec-in' },
        { id: 'e-clrdisplay-dlg', source: 'clear-display', target: 'dialog-remove', sourceHandle: 'exec-out', targetHandle: 'exec-in' },
        ...
        // Display update data edges
        { id: 'd-text-fmt', source: 'get-text-add', target: 'fmt-task-nl', sourceHandle: 'data-out', targetHandle: 'data-in-arg-0' },
        { id: 'd-fmt-append', source: 'fmt-task-nl', target: 'append-display', sourceHandle: 'data-out', targetHandle: 'data-in-text' },
        { id: 'd-empty-clear', source: 'lit-empty', target: 'clear-display', sourceHandle: 'data-out', targetHandle: 'data-in-text' },
