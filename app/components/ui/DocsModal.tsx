...
function GettingStarted() {
  return (
    <div>
      <h2 style={h2}>Getting Started with JWire</h2>
      <p style={{ color: '#bbb', marginBottom: 16 }}>
        JWire is a visual node-based IDE for building Java programs. Instead of writing code
...
function TypeSystem() {
  ...
  return (
    <div>
      ...
      <p style={{ color: '#bbb', marginBottom: 16 }}>
        JWire uses color-coded connections to distinguish data types. You can only connect
      ...
      <div ref={modalRef} style={modal} role="dialog" aria-modal="true" aria-label="Documentation" onClick={e => e.stopPropagation()} onKeyDown={handleTabTrap}>
        ...
        <div style={header}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <h1 style={{ margin: 0, fontSize: 18, fontWeight: 700, color: '#fff' }}>JWire Documentation</h1>
          </div>
          <button
            ref={closeButtonRef}
            onClick={onClose}
