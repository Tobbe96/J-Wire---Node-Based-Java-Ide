...
const PriorityQueueOpNode = ({ data, selected, id }: Props) => {
  ...
  const wrap = (children: React.ReactNode) => (
    <div style={{ ...nodeContainer(ACCENT, !!selected), minWidth: '195px' }}>
      <div className="jflow-header-shimmer" style={nodeHeaderSolid(ACCENT)}>{header}</div>
...
export default memo(PriorityQueueOpNode);
