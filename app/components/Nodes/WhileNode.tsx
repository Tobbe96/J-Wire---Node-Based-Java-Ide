...
import type { WhileNodeData } from '../../utils/nodeTypes';
...
interface WhileNodeDataExt extends WhileNodeData {
  loopLabel?: string;
  updateNodeData?: (id: string, data: Record<string, unknown>) => void;
}

const WhileNode = ({ id, data, selected }: NodeProps<Node<WhileNodeDataExt>>) => {
